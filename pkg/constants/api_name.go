...
var allowedCallersByChain = map[APIName]map[Chain]bool{
	...
	TXN_GetTokenTxns: {ETH: true, BSC: true, MATIC: true, SOL: true, ZILLIQA: true, AVALANCHE: true,
		XDC: true, OPTIMISM: true, ARBITRUM: true, CELO: true, FANTOM: true, KLAYTN: true, FUSE: true, KRONOS: true},
	TXN_GetTxnDetails: {ETH: true, BSC: true, MATIC: true, SOL: true, AVALANCHE: true, XDC: true,
		OPTIMISM: true, ARBITRUM: true, CELO: true, FANTOM: true, KLAYTN: true, FUSE: true, KRONOS: true},
	TXN_GetTokenTxnsV2: {ETH: true, BSC: true, MATIC: true, AVALANCHE: true, XDC: true, OPTIMISM: true,
		ARBITRUM: true, CELO: true, FANTOM: true, KLAYTN: true, FUSE: true, KRONOS: true},
